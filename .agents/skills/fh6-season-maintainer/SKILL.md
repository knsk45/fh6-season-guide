...
2. For the combined Daily card, independently seek the complete list of all `season.expectedDailyItems` in the live official Playlist/News and fresh current-week Reddit Information Threads before relying on which days happen to be visible in a screenshot. A screenshot is evidence for the exact tile only; do not wait for future Daily rows to open in it. Fill confirmed future days immediately, and request a condition screenshot only after the live sources have been exhausted.
